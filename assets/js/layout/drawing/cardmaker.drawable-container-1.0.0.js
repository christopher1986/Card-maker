(function(window, document, cardmaker, undefined) {
    ...
    /**
     * The DrawableContainer represents a composite of {@link cardmaker.Drawable} objects and
     * is the base class for drawable objects that have children.
     *
     ...
     * @inheritdoc
     */
    DrawableContainer.prototype.onDraw = function(canvas) {
     ...
     * @public
     */
    DrawableContainer.prototype.addChild = function(child) {
     ...
     * @public
     */
    DrawableContainer.prototype.clear = function() {
        var index, size, child;
        for (index = 0, size = this.size(); index < size; index++) {
            child = this.children[index];
            if (this.isAllowed(child)) {
     ...
     * @public
     */
    DrawableContainer.prototype.size = function() {
     ...
     */
    DrawableContainer.prototype.isAllowed = function(child) {
